# `compile` crash
**file**: 0xcdab36f3a9d4705a0f27bfde64d770597945376a.sol

**cmd**: solang compile --target substrate 0xcdab36f3a9d4705a0f27bfde64d770597945376a.sol 2>&1
...
# Compiler Message
```
thread 'main' panicked at 'type not allowed', src/sema/types.rs:1287:18
