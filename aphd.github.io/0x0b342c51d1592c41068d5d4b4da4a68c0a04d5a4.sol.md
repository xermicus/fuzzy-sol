# `compile` crash
**file**: 0x0b342c51d1592c41068d5d4b4da4a68c0a04d5a4.sol

**cmd**: solang compile --target substrate 0x0b342c51d1592c41068d5d4b4da4a68c0a04d5a4.sol 2>&1
...
[0m[1m[38;5;11mwarning[0m[1m: 'public': visibility for constructors is ignored[0m
    [0m[34m┌─[0m /home/glow/code/fuzzy/aphd.github.io/0x0b342c51d1592c41068d5d4b4da4a68c0a04d5a4.sol:208:19
    [0m[34m│[0m
[0m[34m208[0m [0m[34m│[0m     constructor() [0m[33mpublic[0m {
    [0m[34m│[0m                   [0m[33m^^^^^^[0m

[0m[1m[38;5;11mwarning[0m[1m: declaration of 'name' shadows function[0m
    [0m[34m┌─[0m /home/glow/code/fuzzy/aphd.github.io/0x0b342c51d1592c41068d5d4b4da4a68c0a04d5a4.sol:284:32
    [0m[34m│[0m
[0m[34m284[0m [0m[34m│[0m     constructor (string memory [0m[33mname[0m, string memory symbol, uint256 supply, uint8 decimals) public OneSwapBlackList() {
    [0m[34m│[0m                                [0m[33m^^^^[0m
    [0m[34m·[0m
[0m[34m292[0m [0m[34m│[0m     function name() public view override returns (string memory) {
    [0m[34m│[0m              [0m[34m----[0m [0m[34mprevious declaration of function[0m

[0m[1m[38;5;11mwarning[0m[1m: declaration of 'symbol' shadows function[0m
    [0m[34m┌─[0m /home/glow/code/fuzzy/aphd.github.io/0x0b342c51d1592c41068d5d4b4da4a68c0a04d5a4.sol:284:52
    [0m[34m│[0m
[0m[34m284[0m [0m[34m│[0m     constructor (string memory name, string memory [0m[33msymbol[0m, uint256 supply, uint8 decimals) public OneSwapBlackList() {
    [0m[34m│[0m                                                    [0m[33m^^^^^^[0m
    [0m[34m·[0m
[0m[34m296[0m [0m[34m│[0m     function symbol() public view override returns (string memory) {
    [0m[34m│[0m              [0m[34m------[0m [0m[34mprevious declaration of function[0m

[0m[1m[38;5;11mwarning[0m[1m: declaration of 'decimals' shadows function[0m
    [0m[34m┌─[0m /home/glow/code/fuzzy/aphd.github.io/0x0b342c51d1592c41068d5d4b4da4a68c0a04d5a4.sol:284:82
    [0m[34m│[0m
[0m[34m284[0m [0m[34m│[0m     constructor (string memory name, string memory symbol, uint256 supply, uint8 [0m[33mdecimals[0m) public OneSwapBlackList() {
    [0m[34m│[0m                                                                                  [0m[33m^^^^^^^^[0m
    [0m[34m·[0m
[0m[34m300[0m [0m[34m│[0m     function decimals() public view override returns (uint8) {
    [0m[34m│[0m              [0m[34m--------[0m [0m[34mprevious declaration of function[0m

[0m[1m[38;5;11mwarning[0m[1m: 'public': visibility for constructors is ignored[0m
    [0m[34m┌─[0m /home/glow/code/fuzzy/aphd.github.io/0x0b342c51d1592c41068d5d4b4da4a68c0a04d5a4.sol:284:92
    [0m[34m│[0m
[0m[34m284[0m [0m[34m│[0m     constructor (string memory name, string memory symbol, uint256 supply, uint8 decimals) [0m[33mpublic[0m OneSwapBlackList() {
    [0m[34m│[0m                                                                                            [0m[33m^^^^^^[0m

thread 'main' panicked at 'Found PointerValue(PointerValue { ptr_value: Value { name: "elem", address: 0x5577e4ee6450, is_const: false, is_null: false, is_undef: false, llvm_value: "  %elem = bitcast i8* %index_access to i256*", llvm_type: "i256*" } }) but expected the IntValue variant', /home/glow/.cargo/registry/src/github.com-1ecc6299db9ec823/inkwell-0.1.0-beta.5/src/values/enums.rs:286:13
...
```
[0m[1m[38;5;11mwarning[0m[1m: 'public': visibility for constructors is ignored[0m
    [0m[34m┌─[0m /home/cyrill/mess/fuzzy-sol/aphd.github.io/0x0b342c51d1592c41068d5d4b4da4a68c0a04d5a4.sol:208:19
    [0m[34m│[0m
[0m[34m208[0m [0m[34m│[0m     constructor() [0m[33mpublic[0m {
    [0m[34m│[0m                   [0m[33m^^^^^^[0m

[0m[1m[38;5;11mwarning[0m[1m: declaration of 'name' shadows function[0m
    [0m[34m┌─[0m /home/cyrill/mess/fuzzy-sol/aphd.github.io/0x0b342c51d1592c41068d5d4b4da4a68c0a04d5a4.sol:284:32
    [0m[34m│[0m
[0m[34m284[0m [0m[34m│[0m     constructor (string memory [0m[33mname[0m, string memory symbol, uint256 supply, uint8 decimals) public OneSwapBlackList() {
    [0m[34m│[0m                                [0m[33m^^^^[0m
    [0m[34m·[0m
...
[0m[1m[38;5;11mwarning[0m[1m: declaration of 'symbol' shadows function[0m
    [0m[34m┌─[0m /home/cyrill/mess/fuzzy-sol/aphd.github.io/0x0b342c51d1592c41068d5d4b4da4a68c0a04d5a4.sol:284:52
    [0m[34m│[0m
[0m[34m284[0m [0m[34m│[0m     constructor (string memory name, string memory [0m[33msymbol[0m, uint256 supply, uint8 decimals) public OneSwapBlackList() {
    [0m[34m│[0m                                                    [0m[33m^^^^^^[0m
    [0m[34m·[0m
...
[0m[1m[38;5;11mwarning[0m[1m: declaration of 'decimals' shadows function[0m
    [0m[34m┌─[0m /home/cyrill/mess/fuzzy-sol/aphd.github.io/0x0b342c51d1592c41068d5d4b4da4a68c0a04d5a4.sol:284:82
    [0m[34m│[0m
[0m[34m284[0m [0m[34m│[0m     constructor (string memory name, string memory symbol, uint256 supply, uint8 [0m[33mdecimals[0m) public OneSwapBlackList() {
    [0m[34m│[0m                                                                                  [0m[33m^^^^^^^^[0m
    [0m[34m·[0m
...
[0m[1m[38;5;11mwarning[0m[1m: 'public': visibility for constructors is ignored[0m
    [0m[34m┌─[0m /home/cyrill/mess/fuzzy-sol/aphd.github.io/0x0b342c51d1592c41068d5d4b4da4a68c0a04d5a4.sol:284:92
    [0m[34m│[0m
[0m[34m284[0m [0m[34m│[0m     constructor (string memory name, string memory symbol, uint256 supply, uint8 decimals) [0m[33mpublic[0m OneSwapBlackList() {
    [0m[34m│[0m                                                                                            [0m[33m^^^^^^[0m

thread 'main' panicked at 'Found PointerValue(PointerValue { ptr_value: Value { name: "elem", address: 0x55e8d1fe2250, is_const: false, is_null: false, is_undef: false, llvm_value: "  %elem = bitcast i8* %index_access to i256*", llvm_type: "i256*" } }) but expected the IntValue variant', /home/cyrill/.cargo/registry/src/github.com-1ecc6299db9ec823/inkwell-0.1.0-beta.5/src/values/enums.rs:286:13
note: run with `RUST_BACKTRACE=1` environment variable to display a backtrace
```
