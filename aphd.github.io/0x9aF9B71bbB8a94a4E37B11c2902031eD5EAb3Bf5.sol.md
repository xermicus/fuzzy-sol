# `compile` crash
**file**: 0x9aF9B71bbB8a94a4E37B11c2902031eD5EAb3Bf5.sol
**cmd**: solang compile --target substrate 0x9aF9B71bbB8a94a4E37B11c2902031eD5EAb3Bf5.sol 2>&1
**ret**: 101 
**ver**: solang version v0.2.0-14-g3234e18e

# Compiler Message
```
[0m[1m[38;5;11mwarning[0m[1m: destructure variable 'minted' has never been used[0m
    [0m[34m┌─[0m /home/glow/code/fuzzy/aphd.github.io/0x9aF9B71bbB8a94a4E37B11c2902031eD5EAb3Bf5.sol:568:33
    [0m[34m│[0m
[0m[34m568[0m [0m[34m│[0m         (uint256 limit, uint256 [0m[33mminted[0m) =
    [0m[34m│[0m                                 [0m[33m^^^^^^[0m

[0m[1m[38;5;11mwarning[0m[1m: function can be declared 'pure'[0m
    [0m[34m┌─[0m /home/glow/code/fuzzy/aphd.github.io/0x9aF9B71bbB8a94a4E37B11c2902031eD5EAb3Bf5.sol:646:5
    [0m[34m│[0m  
[0m[34m646[0m [0m[34m│[0m [0m[33m╭[0m     [0m[33mfunction onERC1155Received([0m
[0m[34m647[0m [0m[34m│[0m [0m[33m│[0m [0m[33m        address operator,[0m
[0m[34m648[0m [0m[34m│[0m [0m[33m│[0m [0m[33m        address from,[0m
[0m[34m649[0m [0m[34m│[0m [0m[33m│[0m [0m[33m        uint256 id,[0m
    [0m[34m·[0m [0m[33m│[0m
[0m[34m654[0m [0m[34m│[0m [0m[33m│[0m [0m[33m        override[0m
[0m[34m655[0m [0m[34m│[0m [0m[33m│[0m [0m[33m        returns(bytes4)[0m
    [0m[34m│[0m [0m[33m╰[0m[0m[33m───────────────────────^[0m

[0m[1m[38;5;11mwarning[0m[1m: function parameter 'operator' has never been read[0m
    [0m[34m┌─[0m /home/glow/code/fuzzy/aphd.github.io/0x9aF9B71bbB8a94a4E37B11c2902031eD5EAb3Bf5.sol:647:17
    [0m[34m│[0m
[0m[34m647[0m [0m[34m│[0m         address [0m[33moperator[0m,
    [0m[34m│[0m                 [0m[33m^^^^^^^^[0m

[0m[1m[38;5;11mwarning[0m[1m: function parameter 'from' has never been read[0m
    [0m[34m┌─[0m /home/glow/code/fuzzy/aphd.github.io/0x9aF9B71bbB8a94a4E37B11c2902031eD5EAb3Bf5.sol:648:17
    [0m[34m│[0m
[0m[34m648[0m [0m[34m│[0m         address [0m[33mfrom[0m,
    [0m[34m│[0m                 [0m[33m^^^^[0m

[0m[1m[38;5;11mwarning[0m[1m: function parameter 'id' has never been read[0m
    [0m[34m┌─[0m /home/glow/code/fuzzy/aphd.github.io/0x9aF9B71bbB8a94a4E37B11c2902031eD5EAb3Bf5.sol:649:17
    [0m[34m│[0m
[0m[34m649[0m [0m[34m│[0m         uint256 [0m[33mid[0m,
    [0m[34m│[0m                 [0m[33m^^[0m

[0m[1m[38;5;11mwarning[0m[1m: function parameter 'value' has never been read[0m
    [0m[34m┌─[0m /home/glow/code/fuzzy/aphd.github.io/0x9aF9B71bbB8a94a4E37B11c2902031eD5EAb3Bf5.sol:650:17
    [0m[34m│[0m
[0m[34m650[0m [0m[34m│[0m         uint256 [0m[33mvalue[0m,
    [0m[34m│[0m                 [0m[33m^^^^^[0m

[0m[1m[38;5;11mwarning[0m[1m: function parameter 'data' has never been read[0m
    [0m[34m┌─[0m /home/glow/code/fuzzy/aphd.github.io/0x9aF9B71bbB8a94a4E37B11c2902031eD5EAb3Bf5.sol:651:24
    [0m[34m│[0m
[0m[34m651[0m [0m[34m│[0m         bytes calldata [0m[33mdata[0m
    [0m[34m│[0m                        [0m[33m^^^^[0m

[0m[1m[38;5;11mwarning[0m[1m: function can be declared 'pure'[0m
    [0m[34m┌─[0m /home/glow/code/fuzzy/aphd.github.io/0x9aF9B71bbB8a94a4E37B11c2902031eD5EAb3Bf5.sol:673:5
    [0m[34m│[0m  
[0m[34m673[0m [0m[34m│[0m [0m[33m╭[0m     [0m[33mfunction onERC1155BatchReceived([0m
[0m[34m674[0m [0m[34m│[0m [0m[33m│[0m [0m[33m        address operator,[0m
[0m[34m675[0m [0m[34m│[0m [0m[33m│[0m [0m[33m        address from,[0m
[0m[34m676[0m [0m[34m│[0m [0m[33m│[0m [0m[33m        uint256[] calldata ids,[0m
    [0m[34m·[0m [0m[33m│[0m
[0m[34m681[0m [0m[34m│[0m [0m[33m│[0m [0m[33m        override[0m
[0m[34m682[0m [0m[34m│[0m [0m[33m│[0m [0m[33m        returns(bytes4)[0m
    [0m[34m│[0m [0m[33m╰[0m[0m[33m───────────────────────^[0m

[0m[1m[38;5;11mwarning[0m[1m: function parameter 'operator' has never been read[0m
    [0m[34m┌─[0m /home/glow/code/fuzzy/aphd.github.io/0x9aF9B71bbB8a94a4E37B11c2902031eD5EAb3Bf5.sol:674:17
    [0m[34m│[0m
[0m[34m674[0m [0m[34m│[0m         address [0m[33moperator[0m,
    [0m[34m│[0m                 [0m[33m^^^^^^^^[0m

[0m[1m[38;5;11mwarning[0m[1m: function parameter 'from' has never been read[0m
    [0m[34m┌─[0m /home/glow/code/fuzzy/aphd.github.io/0x9aF9B71bbB8a94a4E37B11c2902031eD5EAb3Bf5.sol:675:17
    [0m[34m│[0m
[0m[34m675[0m [0m[34m│[0m         address [0m[33mfrom[0m,
    [0m[34m│[0m                 [0m[33m^^^^[0m

[0m[1m[38;5;11mwarning[0m[1m: function parameter 'ids' has never been read[0m
    [0m[34m┌─[0m /home/glow/code/fuzzy/aphd.github.io/0x9aF9B71bbB8a94a4E37B11c2902031eD5EAb3Bf5.sol:676:28
    [0m[34m│[0m
[0m[34m676[0m [0m[34m│[0m         uint256[] calldata [0m[33mids[0m,
    [0m[34m│[0m                            [0m[33m^^^[0m

[0m[1m[38;5;11mwarning[0m[1m: function parameter 'values' has never been read[0m
    [0m[34m┌─[0m /home/glow/code/fuzzy/aphd.github.io/0x9aF9B71bbB8a94a4E37B11c2902031eD5EAb3Bf5.sol:677:28
    [0m[34m│[0m
[0m[34m677[0m [0m[34m│[0m         uint256[] calldata [0m[33mvalues[0m,
    [0m[34m│[0m                            [0m[33m^^^^^^[0m

[0m[1m[38;5;11mwarning[0m[1m: function parameter 'data' has never been read[0m
    [0m[34m┌─[0m /home/glow/code/fuzzy/aphd.github.io/0x9aF9B71bbB8a94a4E37B11c2902031eD5EAb3Bf5.sol:678:24
    [0m[34m│[0m
[0m[34m678[0m [0m[34m│[0m         bytes calldata [0m[33mdata[0m
    [0m[34m│[0m                        [0m[33m^^^^[0m

thread 'main' panicked at 'no entry found for key', src/emit/instructions.rs:485:29
