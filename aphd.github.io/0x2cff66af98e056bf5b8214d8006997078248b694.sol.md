# `compile` crash
**file**: 0x2cff66af98e056bf5b8214d8006997078248b694.sol

**cmd**: solang compile --target substrate 0x2cff66af98e056bf5b8214d8006997078248b694.sol 2>&1
...
# Compiler Message
```
thread 'main' panicked at 'deref on non-array', src/sema/types.rs:1093:18
