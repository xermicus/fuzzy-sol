# `compile` crash
**file**: 0x961Ae24a1Ceba861D1FDf723794f6024Dc5485Cf.sol

**cmd**: solang compile --target substrate 0x961Ae24a1Ceba861D1FDf723794f6024Dc5485Cf.sol 2>&1
...
[0m[1m[38;5;11mwarning[0m[1m: 'public': visibility for constructors is ignored[0m
    [0m[34m┌─[0m /home/glow/code/fuzzy/aphd.github.io/0x961Ae24a1Ceba861D1FDf723794f6024Dc5485Cf.sol:147:67
    [0m[34m│[0m
[0m[34m147[0m [0m[34m│[0m     constructor(address gemJoin_, address daiJoin_, address vow_) [0m[33mpublic[0m {
    [0m[34m│[0m                                                                   [0m[33m^^^^^^[0m

thread 'main' panicked at 'Found ArrayValue(ArrayValue { name: "", address: 0x55ac65d03720, is_const: false, is_const_array: false, is_const_data_array: false, is_null: false, llvm_value: "[32 x i8] %0", llvm_type: ArrayType { array_type: Type { address: 0x55ac65cd10a0, llvm_type: "[32 x i8]" } } }) but expected the IntValue variant', /home/glow/.cargo/registry/src/github.com-1ecc6299db9ec823/inkwell-0.1.0-beta.5/src/values/enums.rs:286:13
