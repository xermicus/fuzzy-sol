# `compile` crash
**file**: 0xdef1fae3a7713173c168945b8704d4600b6fc7b9.sol

**cmd**: solang compile --target substrate 0xdef1fae3a7713173c168945b8704d4600b6fc7b9.sol 2>&1
...
[0m[1m[38;5;11mwarning[0m[1m: conversion truncates uint256 to uint32, as memory size is type uint32 on target substrate[0m
    [0m[34m┌─[0m /home/glow/code/fuzzy/aphd.github.io/0xdef1fae3a7713173c168945b8704d4600b6fc7b9.sol:257:41
    [0m[34m│[0m
[0m[34m257[0m [0m[34m│[0m         bytes memory buffer = new bytes([0m[33mdigits[0m);
    [0m[34m│[0m                                         [0m[33m^^^^^^[0m

[0m[1m[38;5;11mwarning[0m[1m: conversion truncates uint256 to uint32, as memory size is type uint32 on target substrate[0m
    [0m[34m┌─[0m /home/glow/code/fuzzy/aphd.github.io/0xdef1fae3a7713173c168945b8704d4600b6fc7b9.sol:286:41
    [0m[34m│[0m
[0m[34m286[0m [0m[34m│[0m         bytes memory buffer = new bytes([0m[33m2 * length + 2[0m);
    [0m[34m│[0m                                         [0m[33m^^^^^^^^^^^^^^[0m

[0m[1m[38;5;11mwarning[0m[1m: conversion truncates uint256 to uint32, as memory size is type uint32 on target substrate[0m
     [0m[34m┌─[0m /home/glow/code/fuzzy/aphd.github.io/0xdef1fae3a7713173c168945b8704d4600b6fc7b9.sol:1289:60
     [0m[34m│[0m
[0m[34m1289[0m [0m[34m│[0m         Investor[] memory listOfInvestors = new Investor[]([0m[33mnumItems[0m);
     [0m[34m│[0m                                                            [0m[33m^^^^^^^^[0m

solang: /home/runner/work/solang/solang/llvm-project/llvm/lib/Support/APInt.cpp:2138: void llvm::APInt::fromString(unsigned int, llvm::StringRef, uint8_t): Assertion `(((slen-1)*64)/22 <= numbits || radix != 10) && "Insufficient bit width"' failed.
```
...
```
[0m[1m[38;5;11mwarning[0m[1m: conversion truncates uint256 to uint32, as memory size is type uint32 on target substrate[0m
    [0m[34m┌─[0m /home/cyrill/mess/fuzzy-sol/aphd.github.io/0xdef1fae3a7713173c168945b8704d4600b6fc7b9.sol:257:41
    [0m[34m│[0m
[0m[34m257[0m [0m[34m│[0m         bytes memory buffer = new bytes([0m[33mdigits[0m);
    [0m[34m│[0m                                         [0m[33m^^^^^^[0m

[0m[1m[38;5;11mwarning[0m[1m: conversion truncates uint256 to uint32, as memory size is type uint32 on target substrate[0m
    [0m[34m┌─[0m /home/cyrill/mess/fuzzy-sol/aphd.github.io/0xdef1fae3a7713173c168945b8704d4600b6fc7b9.sol:286:41
    [0m[34m│[0m
[0m[34m286[0m [0m[34m│[0m         bytes memory buffer = new bytes([0m[33m2 * length + 2[0m);
    [0m[34m│[0m                                         [0m[33m^^^^^^^^^^^^^^[0m

[0m[1m[38;5;11mwarning[0m[1m: conversion truncates uint256 to uint32, as memory size is type uint32 on target substrate[0m
     [0m[34m┌─[0m /home/cyrill/mess/fuzzy-sol/aphd.github.io/0xdef1fae3a7713173c168945b8704d4600b6fc7b9.sol:1289:60
     [0m[34m│[0m
[0m[34m1289[0m [0m[34m│[0m         Investor[] memory listOfInvestors = new Investor[]([0m[33mnumItems[0m);
     [0m[34m│[0m                                                            [0m[33m^^^^^^^^[0m

solang: /home/runner/work/solang/solang/llvm-project/llvm/lib/Support/APInt.cpp:2098: void llvm::APInt::fromString(unsigned int, llvm::StringRef, uint8_t): Assertion `(((slen-1)*64)/22 <= numbits || radix != 10) && "Insufficient bit width"' failed.
```
