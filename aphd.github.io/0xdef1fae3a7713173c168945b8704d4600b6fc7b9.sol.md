...
[0m[1m[38;5;11mwarning[0m[1m: conversion truncates uint256 to uint32, as memory size is type uint32 on target substrate[0m
    [0m[34m┌─[0m /home/glow/code/fuzzy/aphd.github.io/0xdef1fae3a7713173c168945b8704d4600b6fc7b9.sol:257:31
    [0m[34m│[0m
[0m[34m257[0m [0m[34m│[0m         bytes memory buffer = [0m[33mnew bytes(digits)[0m;
    [0m[34m│[0m                               [0m[33m^^^^^^^^^^^^^^^^^[0m

[0m[1m[38;5;11mwarning[0m[1m: conversion truncates uint256 to uint32, as memory size is type uint32 on target substrate[0m
    [0m[34m┌─[0m /home/glow/code/fuzzy/aphd.github.io/0xdef1fae3a7713173c168945b8704d4600b6fc7b9.sol:286:31
    [0m[34m│[0m
[0m[34m286[0m [0m[34m│[0m         bytes memory buffer = [0m[33mnew bytes(2 * length + 2)[0m;
    [0m[34m│[0m                               [0m[33m^^^^^^^^^^^^^^^^^^^^^^^^^[0m

[0m[1m[38;5;11mwarning[0m[1m: conversion truncates uint256 to uint32, as memory size is type uint32 on target substrate[0m
     [0m[34m┌─[0m /home/glow/code/fuzzy/aphd.github.io/0xdef1fae3a7713173c168945b8704d4600b6fc7b9.sol:1289:45
     [0m[34m│[0m
[0m[34m1289[0m [0m[34m│[0m         Investor[] memory listOfInvestors = [0m[33mnew Investor[](numItems)[0m;
     [0m[34m│[0m                                             [0m[33m^^^^^^^^^^^^^^^^^^^^^^^^[0m
