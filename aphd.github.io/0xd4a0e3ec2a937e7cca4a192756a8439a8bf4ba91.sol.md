# `compile` crash
**file**: 0xd4a0e3ec2a937e7cca4a192756a8439a8bf4ba91.sol
**cmd**: solang compile --target substrate 0xd4a0e3ec2a937e7cca4a192756a8439a8bf4ba91.sol 2>&1
**ret**: 101 
**ver**: solang version v0.2.0-14-g3234e18e

# Compiler Message
```
[0m[1m[38;5;11mwarning[0m[1m: storage variable 'ONE_HOUR' has been assigned, but never read[0m
   [0m[34m┌─[0m /home/glow/code/fuzzy/aphd.github.io/0xd4a0e3ec2a937e7cca4a192756a8439a8bf4ba91.sol:43:5
   [0m[34m│[0m
[0m[34m43[0m [0m[34m│[0m     [0m[33muint16  constant ONE_HOUR = uint16(3600)[0m;
   [0m[34m│[0m     [0m[33m^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^[0m

[0m[1m[38;5;11mwarning[0m[1m: 'public': visibility for constructors is ignored[0m
   [0m[34m┌─[0m /home/glow/code/fuzzy/aphd.github.io/0xd4a0e3ec2a937e7cca4a192756a8439a8bf4ba91.sol:68:40
   [0m[34m│[0m
[0m[34m68[0m [0m[34m│[0m     constructor (address priceSource_) [0m[33mpublic[0m {
   [0m[34m│[0m                                        [0m[33m^^^^^^[0m

[0m[1m[38;5;11mwarning[0m[1m: 'public': visibility for constructors is ignored[0m
    [0m[34m┌─[0m /home/glow/code/fuzzy/aphd.github.io/0xd4a0e3ec2a937e7cca4a192756a8439a8bf4ba91.sol:216:40
    [0m[34m│[0m
[0m[34m216[0m [0m[34m│[0m     constructor (address priceSource_) [0m[33mpublic[0m OSM(priceSource_) {}
    [0m[34m│[0m                                        [0m[33m^^^^^^[0m

[0m[1m[38;5;11mwarning[0m[1m: try-catch error bytes 'revertReason' has never been used[0m
    [0m[34m┌─[0m /home/glow/code/fuzzy/aphd.github.io/0xd4a0e3ec2a937e7cca4a192756a8439a8bf4ba91.sol:253:32
    [0m[34m│[0m
[0m[34m253[0m [0m[34m│[0m             catch(bytes memory [0m[33mrevertReason[0m) {
    [0m[34m│[0m                                [0m[33m^^^^^^^^^^^^[0m

thread 'main' panicked at 'Found PointerValue(PointerValue { ptr_value: Value { name: "struct_literal", address: 0x55d3c5ce4560, is_const: false, is_null: false, is_undef: false, llvm_value: "  %struct_literal = bitcast i8* %0 to { i128, i128 }*", llvm_type: "{ i128, i128 }*" } }) but expected the IntValue variant', /home/glow/.cargo/registry/src/github.com-1ecc6299db9ec823/inkwell-0.1.0-beta.5/src/values/enums.rs:286:13
