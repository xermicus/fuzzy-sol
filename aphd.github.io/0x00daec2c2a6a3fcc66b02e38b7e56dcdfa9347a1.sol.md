# `compile` crash
**file**: 0x00daec2c2a6a3fcc66b02e38b7e56dcdfa9347a1.sol

**cmd**: solang compile --target substrate 0x00daec2c2a6a3fcc66b02e38b7e56dcdfa9347a1.sol 2>&1
...
[0m[1m[38;5;11mwarning[0m[1m: 'public': visibility for constructors is ignored[0m
   [0m[34m┌─[0m /home/glow/code/fuzzy/aphd.github.io/0x00daec2c2a6a3fcc66b02e38b7e56dcdfa9347a1.sol:59:70
   [0m[34m│[0m
[0m[34m59[0m [0m[34m│[0m     constructor(address _chief, address _polling, address _delegate) [0m[33mpublic[0m {
   [0m[34m│[0m                                                                      [0m[33m^^^^^^[0m

thread 'main' panicked at 'Found ArrayValue(ArrayValue { name: "", address: 0x55a9f4235a00, is_const: false, is_const_array: false, is_const_data_array: false, is_null: false, llvm_value: "  %25 = load [32 x i8], [32 x i8]* %24, align 1", llvm_type: ArrayType { array_type: Type { address: 0x55a9f42bdcf0, llvm_type: "[32 x i8]" } } }) but expected the IntValue variant', /home/glow/.cargo/registry/src/github.com-1ecc6299db9ec823/inkwell-0.1.0-beta.5/src/values/enums.rs:286:13
