...
// File contracts/SSoWCollabs.sol
...
contract SSoWCollabs is ERC721, ERC721Enumerable, Ownable {

    // Removed PROVENANCE
    // Removed tokenPrice
    // Removed maxTokenPurchase
    // Removed MAX_TOKENS
    // Removed saleIsActive

    event PermanentURI(string _value, uint256 indexed _id);

    string private _baseURIextended;

    constructor() ERC721("SSoW Collabs", "SC") {
    }
    ...
    function reserveTokens(uint256 numTokens) public onlyOwner {
