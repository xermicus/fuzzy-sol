# `compile` crash
**file**: 0xaa3c75707d726dc7415d57f284197c16ac030ed2.sol

**cmd**: solang compile --target substrate 0xaa3c75707d726dc7415d57f284197c16ac030ed2.sol 2>&1
...
# Compiler Message
```
thread 'main' panicked at 'no entry found for key', src/codegen/expression.rs:2064:34
