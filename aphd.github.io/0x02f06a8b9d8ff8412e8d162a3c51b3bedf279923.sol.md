...
[0m[1m[38;5;11mwarning[0m[1m: conversion truncates uint256 to uint32, as memory size is type uint32 on target substrate[0m
   [0m[34m┌─[0m /home/glow/code/fuzzy/aphd.github.io/0x02f06a8b9d8ff8412e8d162a3c51b3bedf279923.sol:43:13
   [0m[34m│[0m
[0m[34m43[0m [0m[34m│[0m         s = [0m[33mnew Stake[](_to - _from)[0m;
   [0m[34m│[0m             [0m[33m^^^^^^^^^^^^^^^^^^^^^^^^[0m

[0m[1m[38;5;11mwarning[0m[1m: conversion truncates uint256 to uint32, as memory size is type uint32 on target substrate[0m
   [0m[34m┌─[0m /home/glow/code/fuzzy/aphd.github.io/0x02f06a8b9d8ff8412e8d162a3c51b3bedf279923.sol:48:13
   [0m[34m│[0m
[0m[34m48[0m [0m[34m│[0m         s = [0m[33mnew Stake[](stakes.length)[0m;
   [0m[34m│[0m             [0m[33m^^^^^^^^^^^^^^^^^^^^^^^^^^[0m

[0m[1m[38;5;11mwarning[0m[1m: conversion truncates uint256 to uint32, as memory size is type uint32 on target substrate[0m
   [0m[34m┌─[0m /home/glow/code/fuzzy/aphd.github.io/0x02f06a8b9d8ff8412e8d162a3c51b3bedf279923.sol:57:13
   [0m[34m│[0m
[0m[34m57[0m [0m[34m│[0m         s = [0m[33mnew Stake[](stakesOf[_me].length)[0m;
   [0m[34m│[0m             [0m[33m^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^[0m

[0m[1m[38;5;11mwarning[0m[1m: conversion truncates uint256 to uint32, as memory size is type uint32 on target substrate[0m
   [0m[34m┌─[0m /home/glow/code/fuzzy/aphd.github.io/0x02f06a8b9d8ff8412e8d162a3c51b3bedf279923.sol:58:19
   [0m[34m│[0m
[0m[34m58[0m [0m[34m│[0m         indexes = [0m[33mnew uint256[](stakesOf[_me].length)[0m;
   [0m[34m│[0m                   [0m[33m^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^[0m
...
thread 'main' panicked at 'Found PointerValue(PointerValue { ptr_value: Value { name: "elem40", address: 0x5644279edde0, is_const: false, is_null: false, is_undef: false, llvm_value: "  %elem40 = bitcast i8* %index_access39 to i256*", llvm_type: "i256*" } }) but expected the IntValue variant', /home/glow/.cargo/registry/src/github.com-1ecc6299db9ec823/inkwell-0.1.0-beta.5/src/values/enums.rs:286:13
