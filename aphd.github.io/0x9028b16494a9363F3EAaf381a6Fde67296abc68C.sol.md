# `compile` crash
**file**: 0x9028b16494a9363F3EAaf381a6Fde67296abc68C.sol

**cmd**: solang compile --target substrate 0x9028b16494a9363F3EAaf381a6Fde67296abc68C.sol 2>&1
...
[0m[1m[38;5;11mwarning[0m[1m: conversion truncates uint256 to uint32, as memory size is type uint32 on target substrate[0m
   [0m[34m┌─[0m /home/glow/code/fuzzy/aphd.github.io/0x9028b16494a9363F3EAaf381a6Fde67296abc68C.sol:55:31
   [0m[34m│[0m
[0m[34m55[0m [0m[34m│[0m         bytes memory buffer = [0m[33mnew bytes(digits)[0m;
   [0m[34m│[0m                               [0m[33m^^^^^^^^^^^^^^^^^[0m

[0m[1m[38;5;11mwarning[0m[1m: conversion truncates uint256 to uint32, as memory size is type uint32 on target substrate[0m
   [0m[34m┌─[0m /home/glow/code/fuzzy/aphd.github.io/0x9028b16494a9363F3EAaf381a6Fde67296abc68C.sol:84:31
   [0m[34m│[0m
[0m[34m84[0m [0m[34m│[0m         bytes memory buffer = [0m[33mnew bytes(2 * length + 2)[0m;
   [0m[34m│[0m                               [0m[33m^^^^^^^^^^^^^^^^^^^^^^^^^[0m

[0m[1m[38;5;11mwarning[0m[1m: function declared 'view' can be declared 'pure'[0m
    [0m[34m┌─[0m /home/glow/code/fuzzy/aphd.github.io/0x9028b16494a9363F3EAaf381a6Fde67296abc68C.sol:522:5
    [0m[34m│[0m
[0m[34m522[0m [0m[34m│[0m     [0m[33mfunction isVerifiedArtist(uint256 _index, address _account, bytes32[] calldata _merkleProof) public override view returns (bool)[0m {
    [0m[34m│[0m     [0m[33m^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^[0m
