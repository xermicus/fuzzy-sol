...
contract ERC20Token is StandardToken {
    ...
    */
    string public name = "Perfect Diamond Token";                   //fancy name: eg Simon Bucks
    ...
    string public symbol = "PDT";                 //An identifier: eg SBX
...
//make sure this function name matches the contract name above. So if you're token is called TutorialToken, make sure the //contract name above is also TutorialToken instead of ERC20Token
    ...
    function ERC20Token(
        ...
        name = "Perfect Diamond Token";                                   // Set the name for display purposes
        decimals = 6;                            // Amount of decimals for display purposes
        symbol = "PDT";                               // Set the symbol for display purposes
    }
